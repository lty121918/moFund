      ...
      <view class="class-detail-stu">
        ...
        >
          ...
          <view class="class-detail-stu-tip">
            <text
              class="class-detail-stu-tip2"
              v-if="isTeach == 1 && !row.isSufficient"
            >
              余额不足
            </text>
          </view>
...
export default {
  ...
  methods: {
    ...
    // 联系团长
    handlePhone(val) {
      wx.makePhoneCall({ phoneNumber: val //仅为示例，并非真实的电话号码
      })
    },
    /**
     * @function 打开评价评分方法
