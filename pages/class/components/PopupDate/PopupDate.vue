		...
		<uni-popup ref="popup2" @change="change">
			<view class="popup-stu">
				...
				<view class="popup-stu-flex fz28" v-for="row in studentVOList" :key="row.id">
					...
					<view class="text-r popup-stu-status" v-if="row.attendanceStatus==0">待签到</view>
					<view class="color256 text-r popup-stu-status" v-if="row.attendanceStatus==1">已签到</view>
					...
					<view class="text-r popup-stu-status" v-if="row.attendanceStatus==='4'">已退出</view>
					<view class="text-r popup-stu-status" v-if="row.attendanceStatus==='5'">已作废</view>
					<view class="text-r popup-stu-status" v-if="row.attendanceStatus==='6'">已取消</view>
				</view>
			</view>
		</uni-popup>
	</view>
