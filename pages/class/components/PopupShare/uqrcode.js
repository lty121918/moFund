                            ...
                            setTimeout(function() {
                                uni.canvasToTempFilePath({
                                    ...
                                    success: function(res) {
                                        let resData; // ��ͳһΪbase64��ʽ
                                        let tempFilePath = res.tempFilePath; // H5Ϊbase64������Ϊ���·��
                                        ...
                                        if (plus) {
                                            ...
                                            uni.request({
                                                ...
                                                success: res => {
                                                    resData = `data:image/png;base64,${uni.arrayBufferToBase64(res.data)}`; // ��arraybufferת��base64
                                                    options.success && options.success(resData);
                                                    reslove(resData);
                                                }
                                            })
